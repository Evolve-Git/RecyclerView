...
const val ALL_APPS =            11
const val FEATURED_APPS =       0
const val SPECIALS =            1
const val NEW_RELEASES =        2
const val COMING_SOON =         3
const val TOP_SELLERS =         4
const val FAV_APPS =            5
...
const val FEATURED_APPS_URL =   "https://store.steampowered.com/api/featured/"
const val FEATURED_CAT_URL =    "https://store.steampowered.com/api/featuredcategories/"
